<footer class="d-block bg-light mt-6 w-100 text-dark">
    <div class="d-flex flex-row justify-content-around align-items-center py-3" style="background-color: #99A5C5 !important;width:100%">
        <p class="col-4">
            ...
            <br>
            <a href="https://discord.gg/pd9fgTe" class="text-reset" target="_blank"><i class="fa-brands fa-discord"></i></a>
            <a href="https://discord.gg/pd9fgTe" class="text-reset" target="_blank">Discord</a>
            <br>
            <a href="https://groups.google.com/g/vtes-nantes/about" class="text-reset" target="_blank"><i class="fa-solid fa-user-group"></i></a>
            <a href="https://groups.google.com/g/vtes-nantes/about" class="text-reset" target="_blank">vtes-nantes</a>
            <br>Code source du site :
            <a href="https://github.com/Spigushe/vtes-website" class="text-reset" target="_blank" rel="noreferrer"><i class="fa-brands fa-github"></i></a>
            <a href="https://github.com/Spigushe/vtes-website" class="text-reset" target="_blank" rel="noreferrer">GitHub</a>
